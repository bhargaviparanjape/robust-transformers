#!/bin/bash
#SBATCH --job-name=duorc-roberta-questiononly
...
python -m torch.distributed.launch --nproc_per_node=2  --master_port=25235 run_qa_beam_search.py \
    ...
    --max_seq_length 512 \
    --doc_stride 128 \
    --output_dir /gscratch/zlab/bparan/projects/counterfactuals/models/qa_models/roberta_large_finetuned_duorc_questiononly \
