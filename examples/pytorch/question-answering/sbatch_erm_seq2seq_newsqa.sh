#!/bin/bash
#SBATCH --job-name=newsqa-t5-passageonly
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port=22686  run_seq2seq_qa.py \
    ...
    --max_seq_length 512 \
    --doc_stride 128 \
    --output_dir /gscratch/zlab/bparan/projects/counterfactuals/models/qa_models/t5-flan_base_newsqa_passageonly \
