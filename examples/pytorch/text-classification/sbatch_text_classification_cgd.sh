...
python run_glue_cartography.py \
    ...
    --learning_rate 2e-5 \
    --num_train_epochs 3 \
    --output_dir  /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/models/mnli_cgd_roberta_bz32_epoch3_synthetic_v2 \
    --overwrite_cache --overwrite_output_dir \
    --cache_dir /gscratch/zlab/bparan/projects/counterfactuals/data/NLI/MNLI/cache_ \
    --is_robust \
    --reweight_groups \
    --robust_algorithm CGD \
    --logging_steps 50 \
