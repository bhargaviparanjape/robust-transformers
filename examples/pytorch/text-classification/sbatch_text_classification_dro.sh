...
python run_glue_cartography.py \
    ...
    --train_file /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/NLI/MNLI/automatic_slicing/train_resplit_slicing_Xonly_12slices.json \
    ...
    --learning_rate 2e-5 \
    --num_train_epochs 10 \
    --output_dir  /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/models/mnli_gdro_eg_roberta_bz32_epoch10_Xonly_12slices \
