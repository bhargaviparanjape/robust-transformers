...
python -m torch.distributed.launch --nproc_per_node=1 run_glue_cartography.py \
    ...
    --train_file /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/SST2/automatic_slicing/sst2_train_slicing_error_aware_6slices.json \
    --validation_file  /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/SST2/automatic_slicing/sst2_dev_slicing_error_aware_6slices.json  \
    --test_file /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/SST2/automatic_slicing/sst2_dev_slicing_error_aware_6slices.json \
    --save_total_limit 2 \
    --do_train \
    --do_eval \
    --do_predict \
    ...
    --learning_rate 2e-5 \
    --num_train_epochs 10 \
    --output_dir  /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/models/sst2_domino_roberta_bz144_epoch10 \
