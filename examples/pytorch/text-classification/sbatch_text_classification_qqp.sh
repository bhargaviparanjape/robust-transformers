...
python run_glue_cartography.py \
    ...
    --train_file /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/QQP/qqp_train.json \
    --validation_file  /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/QQP/qqp_validation.json  \
    --test_file /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/data/QQP/qqp_validation.json \
    --save_total_limit 2 \
    --do_train \
    --do_eval \
    --do_predict \
    ...
    --learning_rate 2e-5 \
    --num_train_epochs 10 \
    --output_dir  /mmfs1/gscratch/zlab/bparan/projects/counterfactuals/models/qqp_erm_roberta_bz32_epoch10 \
